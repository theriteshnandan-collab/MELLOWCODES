                ...
                <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-between overflow-hidden">
                  <div className="flex justify-between items-start relative z-10 px-2">
                    <div className="flex flex-col gap-2 transition-transform duration-700">
                      <motion.h3 layoutId={`title-${step.id}`} transition={{ duration: 0.8, ease: [0.19, 1, 0.22, 1] }} className="text-3xl md:text-4xl font-black text-black uppercase leading-tight" style={{ fontFamily: "var(--font-space-grotesk)" }}>{step.title}</motion.h3>
                    </div>
                  ...
                  <div className="relative w-full aspect-square flex items-center justify-center py-4 flex-shrink min-h-[100px]">
                   ...
                   <div className="relative z-10 px-2 mt-auto transition-transform duration-700">
                      <motion.p layoutId={`desc-${step.id}`} transition={{ duration: 0.8, ease: [0.19, 1, 0.22, 1] }} className="text-black/50 transition-colors duration-700 text-sm md:text-base leading-relaxed font-medium">
                         {step.desc}
                      </motion.p>
                   </div>
                </div>
